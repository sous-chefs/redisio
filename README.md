...
![cookbook version](http://img.shields.io/badge/cookbook%20version-2.2.3-blue.svg)
Description
===========
...
* `redisio['version']` - the version number of redis to install (also appended to the `base_name` for downloading), default is '2.8.13'
